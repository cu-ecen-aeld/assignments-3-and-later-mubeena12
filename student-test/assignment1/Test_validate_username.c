...
void test_validate_my_username()
{
     ...
     */
    //TEST_ASSERT_TRUE_MESSAGE(false,"mubeena12");
    char *actual_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE("mubeena12", actual_name, "AESD student");
}
